...
import loginIcon from '../Assets/login_icon.png'; // Correct way to import a PNG image
...
const AppNavbar = (props) => {
  ...
  //       </span>
  //       <span>
  //         <img src={login_icon} alt='' width={'50px'} height={'50px'}/>
  //       </span>
  //     </div>
  //   </div>
...
return (
    <nav className="navbar">
      <div className="navbar-container">
        <div className="logo">
          <img src={loginIcon} alt="" className='logo' />
        </div>
  ...
  //       <button className="home-register button">Login</button>
